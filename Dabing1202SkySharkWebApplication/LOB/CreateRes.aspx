<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CreateRes.aspx.cs" Inherits="Dabing1202SkySharkWebApplication.LOB.CreateRes" %>
            ...
            <WizardSteps>
                <asp:WizardStep ID="WizardStep1" runat="server" Title="Search Flight" >
                                  ...
                                  <table >
                                      <tr>
                                          <td colspan="3">
                                              <asp:Label ID="Label2" runat="server" Text="Step 1: Specify Ticket Details"></asp:Label>
                                              </td>
                              ...
                              <asp:WizardStep ID="WizardStep2" runat="server" Title="Find flight Fare &amp; Status">
                                  ...
                                  <table>
                                      <tr>
                                          <td colspan="3">
                                              <asp:Label ID="Label5" runat="server" Text="Step 2:Confirm flight status and fare with customer  "></asp:Label></td>
                                          
                                      </tr>
                                      <tr>
                                          <td colspan="3">
                                              <asp:Label ID="lblMessageStep2" runat="server" Text="" ForeColor="Red" Font-Bold="true"></asp:Label></td>
                                      ...
                                      <tr>
                                          <td>
                                              <asp:Label ID="lblFare" runat="server" Text="Fare"></asp:Label></td>
                                          <td>
                          ...
                          <table>
                              <tr>
                                  <td  colspan="3">
                                      <asp:Label ID="Label6" runat="server" Text="Step 3: Confirm Booking"></asp:Label></td>
