<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConfirmRes.aspx.cs" Inherits="Dabing1202SkySharkWebApplication.LOB.ConfirmRes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tabContents">
        <table>
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Confirm  Reservation"></asp:Label></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
