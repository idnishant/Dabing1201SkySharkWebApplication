<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RequestID.aspx.cs" Inherits="Dabing1201SkySharkWebApplication.BM.RequestID" %>
        ...
        <table>
            ...
            <tr>
             ...
             <tr>
                <td></td>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Submit Mail" BackColor="Silver" BorderColor="Blue" />
                 </td>
                <td></td>
            </tr>
             <tr>
