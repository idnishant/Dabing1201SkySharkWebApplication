<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManageUsers.aspx.cs" Inherits="Dabing1201SkySharkWebApplication.NA.ManageUsers" %>
            ...
            <table>
                <tr>
                 ...
                 <tr>
                    <td></td>
                    <td>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/ChangePassword.aspx">Chnage Password</asp:HyperLink></td>
                    <td>
